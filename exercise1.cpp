...
int main()
{
	...
	Shader shader("myVertexShader1.vs", "myFragmentShader1.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniformMatrix4fv(glGetUniformLocation(shader.ID, "ourTransform"), 1, GL_FALSE, glm::value_ptr(trans));
